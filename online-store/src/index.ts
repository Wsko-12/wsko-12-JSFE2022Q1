...
console.log(
    ...
    2. Карточка товара содержит его изображение, название, количество данного товара на складе (Employees), год выхода на рынок, производитель и т.д., находится ли товар в корзине +10
    ...
    5. Фильтры в указанном диапазоне от и до +30
        · фильтры по количеству (Employees) +10
    ...
    6. Фильтры по значению +25
        Выбранные фильтры выделяются стилем.
        · фильтры по производителю (Country) +5
        · фильтры по цвету +5
        × фильтры по размеру (Не знаю, чем можно заменить) +5
        · можно отобразить только популярные товары (товары со скидкой) +5
    ...
    Итог: 215/220
     ...
     фильтры по размеру (Не знаю, чем можно заменить) - можно добавить поле например размерФанКлуба/колличество активных пользователей или даже совсем тупое - колличество символов в имени бренда, для таска - ок
    `
);
